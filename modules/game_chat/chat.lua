...
function init()
	...
	g_keyboard.bindKeyDown('Enter', toggleChat, modules.game_interface.getRootPanel())
...
function toggleChat()
    ...
    local consoleTab = chatWindow:recursiveGetChildById('consoleScrollBar')
  if consoleTab then
  consoleTab:setVisible(true)
    ...
    chatWindow:recursiveGetChildById('consoleScrollBar'):setVisible(false)

...
function getIconByVocation(vocation)
  if vocation == "Guerreiro" then
    return "icons/Knighto"
  elseif vocation == "Barbaro" then
    return "icons/Knight" 
  elseif vocation == "Paladino" then
    return "icons/Knight" 
  elseif vocation == "Templario" then
    return "icons/Knight" 
  elseif vocation == "Druid" then
    return "icons/Druid"
  elseif vocation == "Alquimista" then
    return "icons/Druid"
  elseif vocation == "Sorcerer" then
    return "icons/Sorcerer"
  elseif vocation == "Mago" then
    return "icons/Sorcerer"
  elseif vocation == "Arqueiro" then
    return "icons/Paladino"
  elseif vocation == "Hunter" then
    return "icons/Paladino"
  elseif vocation == "Necromancer" then
    return "icons/Sorcerer"
  elseif vocation == "Evoker" then
    return "icons/Sorcerer"

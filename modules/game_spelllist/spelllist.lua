...
vocationBoxPaladino   = nil
vocationBoxGuerreiro  = nil
...
FILTER_VOCATION_PALADINO  = 3
FILTER_VOCATION_GUERREIRO = 4
FILTER_VOCATION_CIDADAO = 11
...
function init()
  ...
  vocationBoxPaladino   = spelllistWindow:getChildById('vocationBoxPaladino')
  vocationBoxGuerreiro  = spelllistWindow:getChildById('vocationBoxGuerreiro')
  vocationBoxCidadao    = spelllistWindow:getChildById('vocationBoxCidadao')
  ...
  vocationRadioGroup:addWidget(vocationBoxPaladino)
  vocationRadioGroup:addWidget(vocationBoxGuerreiro)
  vocationRadioGroup:addWidget(vocationBoxCidadao)
...
function toggle()
  if spelllistWindow:isVisible() then
    spelllistWindow:hide()
  else
...
function toggleFilter(widget, selectedWidget)
  if widget == vocationRadioGroup then
    ...
    elseif boxId == 'vocationBoxPaladino' then
      filters.vocationId = FILTER_VOCATION_PALADINO
    elseif boxId == 'vocationBoxGuerreiro' then
      filters.vocationId = FILTER_VOCATION_GUERREIRO
    elseif boxId == 'vocationBoxCidadao' then
      filters.vocationId = FILTER_VOCATION_CIDADAO
    end

...
function getEmblemImagePath(emblemId)
  ...
  elseif emblemId == EmblemCustom then
    path = '/images/game/emblems/emblem_custom'
  end
  return path
end
...
function getIconImagePath(iconId)
  ...
  elseif iconId == NpcIconBoat then
    path = '/images/game/npcicons/icon_boat'
  elseif iconId == NpcIconMission then
    path = '/images/game/npcicons/icon_mission'
  elseif iconId == NpcIconExpedition then
    path = '/images/game/npcicons/icon_expedition'
  elseif iconId == NpcIconDornRep then
    path = '/images/game/npcicons/dorn_reputation'
  elseif iconId == NpcIconFrostRep then
    path = '/images/game/npcicons/frosthold_reputation'
  elseif iconId == NpcIconHallowRep then
    path = '/images/game/npcicons/hallowfall_reputation'
  elseif iconId == NpcIconVardenRep then
    path = '/images/game/npcicons/vardenfell_reputation'
  elseif iconId == NpcIconVyrskRep then
    path = '/images/game/npcicons/vyrsk_reputation'
  end
  return path
end
